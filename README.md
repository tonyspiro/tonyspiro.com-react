...
[Webpack](https://webpack.github.io/) is used for the dev and build process to manage turning ES6 JS into browser-friendly ES5 JS using the babel-loader.  The front end style is based off [a theme from Start Bootstrap](http://startbootstrap.com/template-overviews/clean-blog/).
